...
"""
xiphos is a slow post dos testing tool written in Python.
...
class httpPost(Thread):
    ...
    def _send_http_post(self, pause=10):
        ...
        for i in range(0, 9999):
            ...
            print term.BOL+term.UP+term.CLEAR_EOL+"Slashing and dashing! %s" % p+term.NORMAL
            self.socks.send(p)
...
def usage():
    print "./.xiphos.py -t <target> [-r <threads> -p <port> -T -h]"
    print " -t|--target <Hostname|IP>"
    print " -r|--threads <Number of threads> Defaults to 256"
    print " -p|--port <Web Server Port> Defaults to 80"
    print " -T|--tor Enable anonymous attack through tor on 127.0.0.1:9050"
    print " -h|--help Shows this help\n" 
    print "Eg. ./xiphos.py -t 192.168.1.100 -r 256\n"
...
if __name__ == "__main__":
    print "\n/*"
    print " *"+term.RED + " xiphos.py "+term.NORMAL
    print " *__  ___       _                "
    print " *\ \/ (_)_ __ | |__   ___  ___  "
    print " * \  /| | '_ \| '_ \ / _ \/ __| "
    print " * /  \| | |_) | | | | (_) \__ \ "
    print " */_/\_\_| .__/|_| |_|\___/|___/ "
    print " *       |_|                     "
    print " * "
    print " * "
    print " */\n"
